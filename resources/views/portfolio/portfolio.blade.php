...
<section class="section">
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center">
                <h2 class="section-title section-title-border">Portfolio</h2>
        ...
        <div class="row" data-ref="mixitup-container">
            <div class="col-lg-3 col-md-4 col-sm-6 p-0 WebDevelopment" data-ref="mixitup-target">
                <div class="position-relative">
                    ...
                    <div class="project-info">
                        <a href="{{route('home')}}" class="h4">VEN VICI PBS</a>
                        <p>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 p-0 WebDevelopment" data-ref="mixitup-target">
                <div class="position-relative">
                    ...
                    <div class="project-info">
                        <a href="{{route('home')}}" class="h4">Basic Tasar Silkworm seed org.</a>
                        <p>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 p-0 WebDevelopment" data-ref="mixitup-target">
                <div class="position-relative">
                    <img class="img-fluid staticH w-100" src="images/portfolio/14.jpg" alt="project-image">
                    <div class="project-info">
                        <a href="{{route('home')}}" class="h4">WMI Enterprise Pte Ltd.</a>
                        <p>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 p-0 WebDevelopment" data-ref="mixitup-target">
                <div class="position-relative">
                    ...
                    <div class="project-info">
                        <a href="{{route('home')}}" class="h4">DataBase Design & Scraping</a>
                        <p>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 p-0 WebDevelopment " data-ref="mixitup-target">
                <div class="position-relative">
                    ...
                    <div class="project-info">
                        <a href="{{route('home')}}" class="h4">Virtual Project Management Application</a>
                        <p>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 p-0 WebDevelopment " data-ref="mixitup-target">
                <div class="position-relative">
                    <img class="img-fluid staticH w-100" src="images/portfolio/9.png" alt="project-image">
                    <div class="project-info">
                        <a href="{{route('home')}}" class="h4">Stock Management Application</a>
                        <p>
            ...
            <!--        <div class="project-info">-->
            <!--        <a href="{{route('home')}}" class="h4">MM2VIEW</a>-->
            <!--            <p>-->
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 p-0 WebDevelopment" data-ref="mixitup-target">
                <div class="position-relative">
                    ...
                    <div class="project-info">
                        <a href="{{route('home')}}" class="h4">Quote And Invoice System</a>
                        <p>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 p-0 WebDevelopment" data-ref="mixitup-target">
                <div class="position-relative">
                    ...
                    <div class="project-info">
                        <a href="{{route('home')}}" class="h4">Event Sharing In Multiple Site</a>
                        <p>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 p-0 AppDevelopment " data-ref="mixitup-target">
                <div class="position-relative">
                    <img class="img-fluid staticH w-100" src="images/portfolio/29.jpg" alt="project-image">
                    <div class="project-info">
                    <a href="{{route('home')}}" class="h4">FX Hunter</a>
                        <p>
                            <i class="ti-tag"></i>App</p>
                    </div>
                </div>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 p-0  WebDevelopment" data-ref="mixitup-target">
                <div class="position-relative">
                    <img class="img-fluid staticH w-100" src="images/portfolio/16.png" alt="project-image">
                    <div class="project-info">
                        <a href="{{route('home')}}" class="h4">Dealer Distributor System</a>
                        <p>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 p-0  WebDevelopment" data-ref="mixitup-target">
                <div class="position-relative">
                    ...
                    <div class="project-info">
                        <a href="{{route('home')}}" class="h4">CityVox Web Scraping</a>
                        <p>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 p-0 AppDevelopment " data-ref="mixitup-target">
                <div class="position-relative">
                    <img class="img-fluid staticH w-100" src="images/portfolio/30.jpg" alt="project-image">
                    <div class="project-info">
                    <a href="{{route('home')}}" class="h4">PH Hunter</a>
                        <p>
                            <i class="ti-tag"></i>App</p>
                    </div>
                </div>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 p-0  WebDevelopment" data-ref="mixitup-target">
                <div class="position-relative">
                    ...
                    <div class="project-info">
                    <a href="{{route('home')}}" class="h4">Onvasortir Web Scrapping</a>
                        <p>
                            <i class="ti-tag"></i>Images</p>
                    </div>
                </div>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 p-0  WebDevelopment" data-ref="mixitup-target">
                <div class="position-relative">
                    ...
                    <div class="project-info">
                    <a href="{{route('home')}}" class="h4">Search Engine Optimazation</a>
                        <p>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 p-0 WebDevelopment " data-ref="mixitup-target">
                <div class="position-relative">
                    <img class="img-fluid staticH w-100" src="images/portfolio/19.png" alt="project-image">
                    <div class="project-info">
                        <a href="{{route('home')}}" class="h4">Opencart Based E-commerce</a>
                        <p>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 p-0  WebDevelopment" data-ref="mixitup-target">
                <div class="position-relative">
                    ...
                    <div class="project-info">
                        <a href="{{route('home')}}" class="h4">Sugar Block</a>
                        <p>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 p-0 WebDevelopment" data-ref="mixitup-target">
                <div class="position-relative">
                    ...
                    <div class="project-info">
                        <a href="{{route('home')}}" class="h4">Magento Based E-commerce Portal</a>
                        <p>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 p-0 WebDevelopment" data-ref="mixitup-target">
                <div class="position-relative">
                    ...
                    <div class="project-info">
                        <a href="{{route('home')}}" class="h4">Multi Level Marketing</a>
                        <p>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 p-0 WebDevelopment " data-ref="mixitup-target">
                <div class="position-relative">
                    ...
                    <div class="project-info">
                    <a href="{{route('home')}}" class="h4">Web Scraping And UI Design</a>
                        <p>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 p-0 WebDevelopment " data-ref="mixitup-target">
                <div class="position-relative">
                    ...
                    <div class="project-info">
                    <a href="{{route('home')}}" class="h4">C.A.P.E. Profile Consultancy</a>
                        <p>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 p-0 WebDevelopment" data-ref="mixitup-target">
                <div class="position-relative">
                    ...
                    <div class="project-info">
                        <a href="{{route('home')}}" class="h4">Real Estate Market Place</a>
                        <p>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 p-0 WebDevelopment " data-ref="mixitup-target">
                <div class="position-relative">
                    ...
                    <div class="project-info">
                    <a href="{{route('home')}}" class="h4">Online Survey Application</a>
                        <p>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 p-0 WebDevelopment " data-ref="mixitup-target">
                <div class="position-relative">
                    ...
                    <div class="project-info">
                    <a href="{{route('home')}}" class="h4">Timesheet Management System</a>
                        <p>
                            <i class="ti-tag"></i>Images</p>
                    </div>
                </div>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 p-0 WebDevelopment" data-ref="mixitup-target">
                <div class="position-relative">
                    ...
                    <div class="project-info">
                        <a href="{{route('home')}}" class="h4">Platform For Collaboration</a>
                        <p>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 p-0 WebDevelopment" data-ref="mixitup-target">
                <div class="position-relative">
                    ...
                    <div class="project-info">
                        <a href="{{route('home')}}" class="h4">Amazon Barcode Generator</a>
                        <p>
