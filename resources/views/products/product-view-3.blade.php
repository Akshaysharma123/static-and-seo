            ...
            <aside class="col-lg-4 order-lg-1 order-2">
                ...
                <div class="p-4 rounded border mb-50">
                    ...
                    <ul class="pl-0 mb-20">
                        ...
                        <li class="py-3 border-bottom">
                            <span class="d-inline-block" style="width: 140px;">Website:</span><a href="http://explore-nearby.com/">http://explore-nearby.com/</a></li>
                    </ul>
                    <a href="{{route('contact')}}" class="btn btn-primary">Request Free Consultation</a>
                </div>
                <!-- case study -->
